...
fun directChatAdapterDelegate(itemClickedListener: (ChatListItem.Direct) -> Unit): AdapterDelegate<List<ChatListItem>> {
    return adapterDelegateLayoutContainer<ChatListItem.Direct, ChatListItem>(R.layout.chat_list_item) {
