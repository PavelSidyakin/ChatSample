...
fun groupChatAdapterDelegate(itemClickedListener: (ChatListItem.Group) -> Unit): AdapterDelegate<AdapterItemProvider<ChatListItem>> {
    return adapterLayoutContainer<ChatListItem.Group, ChatListItem>(R.layout.chat_list_item) {
