...
fun groupChatAdapterDelegate(itemClickedListener: (ChatListItem.Chat.Group) -> Unit): AdapterDelegate<AdapterItemProvider<ChatListItem>> {
    return adapterLayoutContainer<ChatListItem.Chat.Group, ChatListItem>(R.layout.chat_list_item) {
