package com.example.chatsample.deleates_dsl.dsl
...
internal class DslLayoutContainerAdapterDelegate<I : T, T>(
    ...
    override fun isForViewType(item: T, items: AdapterItemProvider<T>, position: Int): Boolean {
        return item != null && on(item, items, position)
    }
